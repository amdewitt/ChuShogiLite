    ...
    const utils = {
        ...
        disambiguation: {
            ...
            disambiguateMove(gameInstance, move) {
                ...
                if (coordinates.fromSquare === coordinates.toSquare)
                    return move;
      ...
      `;
        ...
        <div class="chushogi-settings">
          ...
          ${
            ...
            <textarea class="chushogi-textarea" placeholder="Paste game in Game Export format (SFEN USIMove1 USIMove2... or USIMove1 USIMove2...) here..." data-game-import=""></textarea>
        ...
        <div class="chushogi-help">
          ...
          <div class="chushogi-setting-group">
            ...
            <div class="chushogi-help-content">
              ...
              <ul>
                <li>📋 Info: Shows information about the current game
                <ul>
                  <li>The Display Inline checkbox allows the move history to be shown in a single line instead of individual rows</li>
                  </li>
                  <li>Moves in the Moves History can be clicked to navigate to their respective positions
                  </li>
                </ul>
                </li>
...
&lt;div class="chuShogiLite" data-config='{
  ...
  "repetitionHandling": "strict"
              ...
              <ul translate="no">
                ...
                <li><strong>startGame:</strong> Game Export string (SFEN USIMove1 USIMove2... or USIMove1 USIMove2...), <span style="text-decoration:underline">null</span></li>
...
`;
        ...
        updateDisplay() {
            try {
                ...
                if (positionDisplay) {
                    try {
                        ...
                        if (
                            ...
                            positionDisplay.textContent = fullText;
                        }
                    } catch (error) {
                        console.error(
                ...
                // Update SFEN export - use navigation-aware SFEN
        ...
        exportSFEN() {
            ...
            const moveNumber = completedMoves + 1;
            sfen += " " + moveNumber;
        ...
        exportGame() {
            ...
            // Add moves in USI notation
            if (this.moveHistory.length > 0) {
                const usiMoves = this.moveHistory
                    .map((move) => this.moveToUSI(move))
                    .filter((usi) => usi);
                if (usiMoves.length > 0) {
                    gameExport += " " + usiMoves.join(" ");
                }
            }
        ...
        loadSFENForNavigation(sfen) {
            ...
            this.startingSFEN = originalStartingSFEN;
        ...
        setStartPosition() {
            ...
            this.startingSFEN = newStartingSFEN;
        ...
        importGame(gameString) {
            const parts = gameString.trim().split(/\s+/);
            if (parts.length === 0) {
            ...
            // Reset navigation state to current position after import
            ...
            // Debug the navigation index after import
            console.log(
                `Import complete: moveHistory.length=${this.moveHistory.length}, navigationIndex=${this.currentNavigationIndex}, isNavigating=${this.isNavigating}`,
            );
            ...
            // Force update square highlights to show last move
            this.updateSquareHighlights();
        ...
        executePromotionMove(shouldPromote) {
            ...
            if (this.promotionMove.isDoubleMove) {
                ...
                if (moveResult === false) {
                    console.log(
                        "Lion double move promotion was rejected, clearing selection and highlights",
                    );
                    this.clearSelection();
                    this.highlightManager.updateAllIntelligent();
                }
